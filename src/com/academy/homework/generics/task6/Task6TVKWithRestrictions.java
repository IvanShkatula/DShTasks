...
public class Task6TVKWithRestrictions<T extends Comparable, V extends Serializable, K extends Number> {

//почему не подхожит implements?????????????????????????????!!!!
  ...
  public Task6TVKWithRestrictions(T variableT, V variableV, K variableK) {
