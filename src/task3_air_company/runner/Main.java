package task3_air_company.runner;

import java.util.ArrayList;
import java.util.List;

import task3_air_company.logic.Logic;
import task3_air_company.planes.CargoAirplane;
import task3_air_company.planes.LightAircraft;
import task3_air_company.planes.PassengerAircraft;
import task3_air_company.planes.Plane;
